...
//      System.out.println("Height at " + ts.getFullName() + " at " + date.getTime() + " = " + d);
    ...
    private static void addStationToTree(com.istudio.tideengine.TideStation ts, TreeMap<String, StationTreeNode> currentTree) {
        ...
        for (String name : ts.getNameParts()) {
            ...
            if (stn == null) {
                ...
                stn.setStationType(ts.isCurrentStation() ? com.istudio.tideengine.TideUtilities.StationTreeNode.CURRENT_STATION : com.istudio.tideengine.TideUtilities.StationTreeNode.TIDE_STATION);
