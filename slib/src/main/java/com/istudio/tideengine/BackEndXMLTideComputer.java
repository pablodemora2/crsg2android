...
public class BackEndXMLTideComputer {
    //public final static String ARCHIVE_STREAM      = "xml.zip";
    ...
    public static Constituents buildConstituents() throws Exception {
        ...
        try {
            ...
            InputStream is = act.getResources().openRawResource(R.raw.constituents);
            //xr.parse(new InputSource(is));

            saxParser.parse(new InputSource(is), scf);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static Map<String, TideStation> getStationData() throws Exception {
        ...
        try {
            ...
            InputStream is = act.getResources().openRawResource(R.raw.stations);
            saxParser.parse(new InputSource(is), sf);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static TideStation reloadOneStation(String stationName) throws Exception {
        ...
        try {
            ...
            //InputSource is = BackEndTideComputer.getZipInputSource(ARCHIVE_STREAM, STATIONS_ENTRY);
            //  String x = getResources().getString(R.string);
    ...
    public static void setAct(Activity pact) {
        act = pact;
    }
