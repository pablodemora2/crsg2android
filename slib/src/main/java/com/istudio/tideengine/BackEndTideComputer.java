...
public class BackEndTideComputer {
    ...
    private static BackEndTideComputer instance = null;
    private static Constituents constituentsObject = null;
    private static Stations stationsObject = null;
    private static Activity act;
    private static boolean verbose = false;

    protected BackEndTideComputer() {

    }

    public static BackEndTideComputer getInstance() {

        if (instance == null) {

            instance = new BackEndTideComputer();
    ...
    public static void setInstance(BackEndTideComputer instance) {

        BackEndTideComputer.instance = instance;
    ...
    public static void connect() throws Exception {
        BackEndXMLTideComputer.setAct(act);
