// author : Edgar Rios C.
// modified : Pablo Mora G.
// todo - cuando se hace clic en mas de un item los mensajes van saliendo desfasados.
...
public class EcoGallery extends EcoGalleryAbsSpinner implements GestureDetector.OnGestureListener {
    ...
    public EcoGallery(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            Field supportStaticTrans = vgClass.getDeclaredField
    ...
    private void setUpChild(View child, int offset, int x, boolean fromLeft) {
        ...
        // Get measure specs
        int childHeightSpec = ViewGroup.getChildMeasureSpec(mHeightMeasureSpec, mSpinnerPadding
                        .top + mSpinnerPadding.bottom,
                lp.height);
        int childWidthSpec = ViewGroup.getChildMeasureSpec(mWidthMeasureSpec, mSpinnerPadding
                        .left + mSpinnerPadding.right,
                lp.width);
    ...
    private class FlingRunnable implements Runnable {
        ...
        public void startUsingVelocity(int initialVelocity) {
            ...
            mScroller.fling(initialX, 0, initialVelocity, 0, 0, Integer.MAX_VALUE, 0, Integer
                    .MAX_VALUE);
            post(this);
        }
