...
public abstract class EcoGalleryAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public void addView(View child, LayoutParams params) {
        throw new UnsupportedOperationException("addView(View, LayoutParams) " + "is not " +
     ...
     * {@link android.view.View.OnCreateContextMenuListener#onCreateContextMenu(android.view
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (EcoGalleryAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0
                    && mItemCount > 0) {
