...
public abstract class EcoGalleryAbsSpinner extends EcoGalleryAdapterView<SpinnerAdapter> {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (selectedPosition >= 0 && mAdapter != null) {
            ...
            if (view != null) {
                ...
                preferredHeight = getChildHeight(view) + mSpinnerPadding.top + mSpinnerPadding
                        .bottom;
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link com.istudio.crsurfguide.gallery
         * .EcoGalleryAbsSpinner#onSaveInstanceState()}
         */
