...
// Está es la clase representando el ListAdapter.
...
public abstract class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Context contexto, int R_layout_IdView,
                       ArrayList<?> entradas) {
        super();
     ...
     *
     * @param entrada La entrada que sera la asociada a la view. La entrada es del
